...
public class LoginActivity extends Activity {
	...
	private void init(){
		...
		Log.e("TEST_BUG", "手机信息 ： " + BaseClass.getMacAdress(getApplicationContext()));
	}
	...
	Handler handler = new Handler() {
		...
		public void handleMessage(Message msg) {
			...
			case register:
				...
				Log.e("TEST_BUG", "注册返回信息   ： " + requestEvent);
				...
				if ("(\"-1\");".equals(requestEvent)) {
					...
					Log.e("TEST_BUG", "ObjectId返回信息   ： " + ObjectId);
					isSave();
					if (isNeedConfig) {
						List<NameValuePair> params = new ArrayList<NameValuePair>();
